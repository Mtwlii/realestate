    ...
    <div class="page-content">
        ...
        <div class="row profile-body">
            ...
            <div class="col-md-8 col-xl-8 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title text-center">Edit Proparty Type</h6>
                        <form class="forms-sample" action="{{ route('update.type') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ $type->type_name }}" name="type_name" class="form-control"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ $type->type_icon }}" name="type_icon" class="form-control"
